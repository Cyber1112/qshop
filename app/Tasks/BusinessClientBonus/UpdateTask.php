...
class UpdateTask{
    ...
    public function run(int $business_client_bonus_id, int $balance, string $status = "not_used"){
        return $this->bonus_repository->updateClientUnusedBonus($business_client_bonus_id, $balance, $status);
    }
